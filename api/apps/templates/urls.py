...
from .views import AbTestViewSet, CampaignCouponViewSet, EmailAssetViewSet, MessageTemplateViewSet
...
router.register(r"coupons", CampaignCouponViewSet, basename="coupon")
